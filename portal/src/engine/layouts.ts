...
export const createDefaultLayouts = (): LayoutModel[] => [
  ...
  layout('clock-weather', 'Weather Clock', 'weather', [
    element({ id: 'time', type: 'clock', x: 0, y: 0, width: 128, height: 16, scale: 2, align: 'center', color: '#F4F7FF' }),
    element({ id: 'date', type: 'date', x: 0, y: 17, width: 128, height: 8, align: 'center', color: '#72E6A8' }),
    element({ id: 'weather-summary', type: 'dynamic_text', x: 0, y: 27, width: 128, height: 8, dataSource: { type: 'weather', path: 'summary', fallback: 'WEERDATA ONTBREEKT' }, align: 'center', color: '#70D7F4', properties: { colorFromWeatherCode: true } }),
    element({ id: 'weather-forecast', type: 'dynamic_text', x: 4, y: 37, width: 78, height: 8, text: '', dataSource: { type: 'weather', path: 'forecast', fallback: '' }, color: '#F4F7FF' }),
    element({ id: 'weather-warning', type: 'dynamic_text', x: 84, y: 37, width: 40, height: 8, text: '', dataSource: { type: 'weather', path: 'warning', fallback: '' }, align: 'right', color: '#72E6A8' }),
    element({ id: 'divider', type: 'line', x: 4, y: 46, width: 120, height: 1, color: '#43506F' }),
    element({ id: 'temperature', type: 'dynamic_text', x: 4, y: 49, width: 58, height: 8, text: '', dataSource: { type: 'weather', path: 'temperatureC', fallback: '--.-' }, suffix: 'C', color: '#F4F7FF' }),
    element({ id: 'wind', type: 'dynamic_text', x: 64, y: 49, width: 60, height: 8, text: '', dataSource: { type: 'weather', path: 'windSpeedMs', fallback: '--.-' }, suffix: 'M/S', color: '#F4F7FF', align: 'right' }),
    element({ id: 'rain-today', type: 'dynamic_text', x: 4, y: 57, width: 58, height: 7, text: '', prefix: 'V ', dataSource: { type: 'weather', path: 'precipitationTodayProbability', fallback: '' }, suffix: '%', color: '#70D7F4' }),
    element({ id: 'rain-tomorrow', type: 'dynamic_text', x: 64, y: 57, width: 60, height: 7, text: '', prefix: 'M ', dataSource: { type: 'weather', path: 'precipitationTomorrowProbability', fallback: '' }, suffix: '%', color: '#70D7F4', align: 'right' }),
  ], 'Klok met datum, gekleurde weercode en omschrijving, verwachting, waarschuwing, temperatuur, wind en neerslagkans vandaag/morgen.'),
