...
export const createDefaultLayouts = (): LayoutModel[] => [
  ...
  layout('clock-weather', 'Weather Clock', 'weather', [
    ...
    element({ id: 'temperature-wind', type: 'dynamic_text', x: 0, y: 49, width: 128, height: 8, dataSource: { type: 'weather', path: 'temperatureWindSummary', fallback: '--.-C --.-M/S' }, align: 'center', color: '#F4F7FF' }),
    element({ id: 'rain-chances', type: 'dynamic_text', x: 0, y: 57, width: 128, height: 7, dataSource: { type: 'weather', path: 'rainSummary', fallback: '' }, align: 'center', color: '#70D7F4' }),
  ], 'Compacte klok met datum, gekleurde weercode en omschrijving, verwachting, waarschuwing, temperatuur, wind en neerslagkans vandaag/morgen.'),
